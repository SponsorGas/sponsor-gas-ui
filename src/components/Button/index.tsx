    ...
    return (
		...
		{/* bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 */}
			...
			>
				{
					isLoading
					? <svg aria-hidden="true" className="w-5 h-5 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-yellow-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				{subText && <span className="text-xs text-gray-300 ml-2">{`(${subText})`}</span>}
