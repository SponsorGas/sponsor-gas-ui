...
export default  function Footer() {
    return (
      <footer className="py-10 md:py-20 border-t">
				<Container>
					<div className="m-auto md:w-10/12 lg:w-10/12 ">
						<div className="flex flex-wrap  justify-between md:flex-nowrap">
							...
							<div className="m-auto mt-16 w-10/12 space-y-6 text-center sm:mt-auto sm:w-5/12 sm:text-left"							>
								<span className="block text-gray-500 dark:text-gray-400" >We change the way user interact with their Dapps</span >
								<span className="block text-gray-500 dark:text-gray-400">Sponsor Gas &copy; <span id="year"></span></span>
